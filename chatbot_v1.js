...
function report_issue(agent)
{
  ...
  var issue_vals={5:"Internet Down",6:"Slow Internet",7:"Buffering problem",8:"No connectivity"};
  
  const intent_val=agent.parameters.issue_num;
  if(intent_val >4 && intent_val<9)
  {
 ...
 agent.add("The issue reported is: "+ val +"\nThe ticket number is: "+trouble_ticket);
  ...
  agent.add("Please enter a valid number");
}
}
  ...
  "richContent": [
    [
      ...
      },
      {
        "type": "list",
        "title": "Slow Internet",
        "subtitle": "Press '6' for Slow Internet",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
      ...
      },
      {
        ...
        "subtitle": "Press '8' for No connectivity",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
